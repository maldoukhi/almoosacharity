...
- [x] **الرسوم البيانية**: إصلاح اختفائها عند التنقل — ResizeObserver + إعادة الرسم عند تغيّر الثيم فقط (كان `updateOptions` يُفرّغ الـdonut عند لمس class أثناء wire:navigate).
