...
#[Fillable([
    'reference', 'title', 'beneficiary_id', 'aid_program_id', 'type', 'status',
...
class Aid extends Model implements HasMedia
{
    ...
    /**
     * Whether this aid was generated by a recurring plan (part of a series),
     * as opposed to raised directly or being a plan's own originating aid.
     */
    public function isRecurringInstance(): bool
    {
        return $this->recurring_aid_plan_id !== null;
    }

    /**
     * A human label for the aid: its custom title when set, otherwise the
     * program name (loaded when available). Used in headers, the
     * submit-confirm modal, and lists so an aid always reads meaningfully
     * even without a title.
     */
    protected function displayTitle(): Attribute
    {
        return Attribute::make(
            get: fn (): ?string => $this->title !== null && $this->title !== ''
                ? $this->title
                : ($this->relationLoaded('program') ? $this->program?->name : null),
        );
    }
}
