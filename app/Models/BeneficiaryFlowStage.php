...
#[Fillable([
    'beneficiary_flow_id', 'name', 'order', 'role', 'assignee_user_ids',
    'allowed_actions',
])]
class BeneficiaryFlowStage extends Model
{
    use LogsActivity;
    ...
    /**
     * The user ids specifically assigned to this stage (in addition to, or
     * instead of, the role).
     *
     ...
     * (The `beneficiaries.review` permission is still enforced separately by
     * the policy.)
     */
