...
/**
 * User create/edit form rendered inside a wire-elements modal, for quick
 * inline entry without leaving the users list.
 */
class FormModal extends ModalComponent
{
    ...
    public function save(): void
    {
        ...
        $this->dispatch('toast', type: 'success', message: __($isUpdate ? 'users.messages.updated' : 'users.messages.created'));
    ...
    {
        return view('livewire.admin.users.form-modal');
    }
}
