                    ...
                    >
                        <div class="flex items-center justify-between gap-3 border-b border-gray-100 bg-gray-50 px-4 py-2.5 dark:border-white/10 dark:bg-white/5">
                            ...
                            <div class="flex items-center gap-1">
                                <x-ui.button type="button" variant="ghost" size="sm" wire:click="moveUp({{ $index }})" @if ($index === 0) disabled @endif>
                                ...
                                <x-ui.button type="button" variant="ghost" size="sm" wire:click="moveDown({{ $index }})" @if ($index === count($questions) - 1) disabled @endif>
                                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
