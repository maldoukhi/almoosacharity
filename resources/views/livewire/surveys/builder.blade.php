    ...
    <form wire:submit="save" class="space-y-6">
        <x-ui.card>
            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                ...
                <label class="flex cursor-pointer items-start gap-3 select-none sm:col-span-2">
                    <span class="relative inline-block h-6 w-11 shrink-0">
                        <input type="checkbox" wire:model="is_required" class="peer sr-only" />
                        <span class="absolute inset-0 rounded-full bg-gray-200 transition-colors duration-200 ease-out peer-checked:bg-primary dark:bg-white/10"></span>
                        <span class="absolute start-0.5 top-0.5 h-5 w-5 rounded-full bg-white shadow transition-transform duration-200 ease-out peer-checked:translate-x-5 rtl:peer-checked:-translate-x-5"></span>
                    </span>
                    <span>
                        <span class="block text-sm font-medium text-gray-700 dark:text-gray-200">{{ __('surveys.field_is_required') }}</span>
                        <span class="mt-0.5 block text-xs text-gray-500 dark:text-gray-400">{{ __('surveys.field_is_required_hint') }}</span>
                    </span>
                </label>
            </div>
        </x-ui.card>
