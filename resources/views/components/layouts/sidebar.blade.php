...
>
    ...
    <nav class="flex-1 space-y-1 overflow-y-auto overflow-x-hidden px-3 py-4">
        ...
        @can('notifications.settings.manage')
            <a
                href="{{ route('admin.settings.fiscal-lock.index') }}"
                wire:navigate
                title="{{ __('reports.fiscal.title') }}"
                @class([
                    'group flex items-center gap-3 rounded-(--radius-brand) border-s-4 px-3 py-2.5 text-sm font-medium transition duration-150 ease-out',
                    'border-transparent bg-primary text-white shadow-sm dark:bg-primary-600' => request()->routeIs('admin.settings.fiscal-lock.*'),
                    'border-transparent text-gray-600 hover:bg-gray-50 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-white/5 dark:hover:text-white' => ! request()->routeIs('admin.settings.fiscal-lock.*'),
                ])
            >
                <svg class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
        ...
        @can('settings.view')
            <a
                ...
                wire:navigate
                title="{{ __('nav.system_health') }}"
                @class([
                    'group flex items-center gap-3 rounded-(--radius-brand) border-s-4 px-3 py-2.5 text-sm font-medium transition duration-150 ease-out',
                    'border-transparent bg-primary text-white shadow-sm dark:bg-primary-600' => request()->routeIs('admin.settings.system-health'),
                    'border-transparent text-gray-600 hover:bg-gray-50 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-white/5 dark:hover:text-white' => ! request()->routeIs('admin.settings.system-health'),
                ])
            >
                <svg class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
