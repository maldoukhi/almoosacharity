...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                /*
                 * What actually needs protecting: the beneficiaries' private
                 * documents/media (storage/app) and the SQLite database file
                 * when running on SQLite. Code lives in git — not backed up.
                 */
                'include' => [
                    storage_path('app'),
             ...
             */
            /*
             * Env-driven: the dev/test container has no sqlite3/mysqldump
             * binaries, so dumps are off by default (the SQLite file itself is
             * included above). On the MySQL production host set
             * BACKUP_DATABASES=mysql (requires mysqldump on the host).
             */
            'databases' => array_filter(explode(',', (string) env('BACKUP_DATABASES', ''))),
        ],
    ...
    'notifications' => [
        /*
         * Only failures email the admin — a success email every night is
         * noise that trains people to ignore the address that matters.
         */
        'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_EMAIL', 'admin@almoosacharity.org'),
