...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withRouting(
        ...
        health: '/up',
        // routes/public.php (phase 6b): unauthenticated, token-only routes
        // (the beneficiary delivery-confirmation link) that must never
        // share the authenticated app's route file.
        then: function (): void {
