...
return [
    ...
    'settings' => [
        ...
        'field_okta_channel_id_hint' => 'يُترك فارغًا لاستخدام القيمة من ملف .env؛ يُملأ تلقائيًا بعد الربط الناجح عبر QR',
        ...
        'okta_verify_missing_config' => 'أدخل رابط الخادم والرمز ومعرّف القناة أولًا',
