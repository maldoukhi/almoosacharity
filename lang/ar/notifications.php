...
return [
    ...
    'settings' => [
        ...
        'tab_messages' => 'قوالب الرسائل',
        'tab_connections' => 'إعدادات الاتصال',
        ...
        'field_combined_delivery_message_hint' => 'عند التفعيل، يُحذف قسم "رسالة تأكيد الاستلام" المنفصل، ويصبح قالب "تسليم الإعانة" أعلاه هو الرسالة الوحيدة المرسلة — أضِف {link} داخله مباشرة ليحمل رابط التأكيد.',
        'combined_template_link_hint' => 'مفعّل: هذا القالب سيُرسل وحده كرسالة تأكيد الاستلام — يجب أن يحتوي على {link}.',
        'combined_template_link_required' => 'لتفعيل دمج الرسائل، يجب أن يحتوي قالب "تسليم الإعانة" على المتغير {link} (لقناة واتساب أيضًا إن كانت مفعّلة).',
        ...
        'field_okta_base_url_hint' => 'يُترك فارغًا لاستخدام الإعداد الافتراضي للنظام',
        'field_okta_channel_id' => 'معرّف القناة (Channel ID)',
        'field_okta_channel_id_hint' => 'لا يُدخل يدويًا: يُملأ تلقائيًا بعد ربط واتساب عبر رمز QR بالأعلى، أو باختيار قناة موجودة.',
        ...
        'okta_channel_unlink' => 'إلغاء الربط',
        'okta_channel_unlink_confirm' => 'هل تريد إلغاء ربط هذه القناة؟ ستحتاج لإعادة الربط عبر QR.',
        'okta_channel_cleared' => 'تم إلغاء ربط القناة',
        'okta_channels_fetch' => 'اختيار قناة موجودة',
        'okta_channels_refresh' => 'تحديث القنوات',
        'okta_channel_disconnected_warning' => 'القناة المستخدمة حاليًا غير متصلة، قد لا تصل رسائل واتساب. أعد ربطها عبر QR أو اختر قناة متصلة من القائمة.',
        'okta_channels_missing_credentials' => 'أدخل رابط الخادم والرمز أولًا لجلب القنوات',
        'okta_channels_empty' => 'لا توجد قنوات مرتبطة بهذا الحساب.',
        'okta_channel_use' => 'استخدام',
        'okta_channel_in_use' => 'قيد الاستخدام',
        'okta_channel_selected' => 'تم اختيار القناة بنجاح',
        ...
        'qr_instructions' => 'افتح واتساب على هاتفك ← الإعدادات ← الأجهزة المرتبطة ← ربط جهاز، ثم امسح الرمز.',
