...
return [
    ...
    'series_modal' => [
        ...
        'add_button' => 'إضافة إعانة يدويًا',
        'add_hint' => 'للحالات الخاصة: أضف إعانة إضافية لهذه السلسلة الآن، دون انتظار الجدولة.',
        'confirm_add' => 'إضافة إعانة جديدة لهذه السلسلة الآن؟ ستُنشأ كمسودة، خارج الجدولة المعتادة.',
    ],
    ...
    'messages' => [
        ...
        'manual_added' => 'تمت إضافة إعانة جديدة إلى السلسلة',
        'source_missing' => 'تعذّر إضافة الإعانة: الإعانة المصدر لهذه الخطة غير متوفرة.',
    ],
];
