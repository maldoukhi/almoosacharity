...
return [
    ...
    'import' => [
        ...
        'template_button' => 'تنزيل القالب الرسمي',
        'template_hint' => 'استخدم القالب الرسمي لتعبئة بياناتك — سيتعرّف عليه النظام تلقائيًا ويربط أعمدته دون الحاجة لربط يدوي.',
        'template_example_note' => 'مثال توضيحي فقط — احذف هذا الصف قبل رفع بياناتك الفعلية.',
        'template_required_hint' => 'هذا الحقل إلزامي.',
        'template_note' => 'ملاحظة: الحقول الإلزامية هي: :fields. احذف صف المثال قبل رفع بياناتك الفعلية.',
        'auto_detected_hint' => 'تم التعرف على القالب الرسمي تلقائيًا',
