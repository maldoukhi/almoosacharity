...
return [
    ...
    'import' => [
        ...
        'subtitle' => 'ارفع ملف Excel أو CSV واربط أعمدته بحقول المستفيد',
        ...
        'preview_hint' => 'هذه أول صفوف من ملفك للمساعدة في مطابقة الأعمدة بصريًا.',
        'mapping_title' => 'ربط الأعمدة',
        'mapping_hint' => 'اختر لكل حقل العمود المقابل له في ملفك، أو اتركه فارغًا لتخطيه. الحقول المعلّمة بـ * إلزامية.',
        'skip_column' => '— تخطي —',
        ...
        'stat_duplicates' => 'مكرّرون (تم تخطيهم)',
        'stat_errors' => 'صفوف بها أخطاء',
        'errors_title' => 'الصفوف التي تم تخطيها',
        'error_row' => 'رقم الصف',
        'error_reason' => 'السبب',
