...
return [
    ...
    'messages' => [
        ...
        'hint_invalid_credentials' => 'مفتاح Taqnyat API غير صحيح أو منتهي الصلاحية، لذلك رفض المزوّد الطلب. افتح إعدادات الإشعارات ← إعدادات الاتصال، أدخل مفتاح API صحيحًا من لوحة تحكم Taqnyat، ثم اضغط "تحقق من الاتصال" للتأكد قبل الحفظ.',
