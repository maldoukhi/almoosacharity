...
return [
    ...
    'settings' => [
        ...
        'section_smtp_title' => 'Email (SMTP) settings',
        'section_smtp_description' => 'The outbound mail server used to send staff notifications and email broadcasts. Leave fields empty to use the system default.',
        'field_mail_host' => 'Host',
        'field_mail_host_hint' => 'e.g. smtp.gmail.com',
        'field_mail_port' => 'Port',
        'field_mail_port_hint' => 'Common: 587 for TLS, 465 for SSL',
        ...
        'field_mail_username_hint' => 'Often the full email address',
        'field_mail_password' => 'Password',
        'field_mail_password_placeholder' => 'Enter the mail password',
        'field_mail_password_hint' => 'Leave empty when saving to keep the current password',
        'field_mail_from_address' => 'From address',
        'field_mail_from_address_hint' => 'The address messages are sent from, e.g. no-reply@almoosacharity.org',
        'field_mail_from_name' => 'From name',
        'field_mail_from_name_hint' => 'The sender name shown to the recipient',
        'mail_password_cleared' => 'The saved mail password was deleted',
        'section_smtp_test_title' => 'Send a test email',
        'section_smtp_test_description' => 'Send a test message to confirm the mail settings work before relying on them.',
        'field_test_email' => 'Test recipient',
        ...
        'test_email_missing' => 'Enter a valid recipient address first',
    ...
    'mail' => [
        'layout' => [
            'automated_note' => 'This is an automated message from the aid management system; please do not reply to it directly.',
        ],
        'awaiting_review' => [
