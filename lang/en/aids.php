...
return [
    ...
    'timeline' => [
        'created' => 'Aid created',
        'submitted' => 'Aid submitted for approval',
        'disbursement_started' => 'Disbursement started — :method',
        'disbursement_delivered' => 'Aid delivered',
        'disbursement_confirmed' => 'Delivery confirmed (second check)',
        'confirmation_sent' => 'Confirmation link sent',
        'confirmation_confirmed' => 'Beneficiary confirmed receipt',
    ],

    'receipt' => [
        'button' => 'Print Receipt',
        'title' => 'Aid Disbursement Receipt',
        'field_reference' => 'Reference',
        ...
        'items_title' => 'Items',
        'no_title' => 'Untitled',
        'signature_recipient' => 'Recipient Signature',
        'signature_official' => 'Authorized Officer Signature',
        'footer_note' => 'This document was issued electronically by the Aid Management System — Al-Moosa Charity Association',
    ],
