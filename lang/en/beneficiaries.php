...
return [
    ...
    'import' => [
        ...
        'subtitle' => 'Upload an Excel or CSV file and map its columns to the beneficiary fields',
        ...
        'preview_hint' => 'These are the first rows of your file to help you match columns visually.',
        'mapping_title' => 'Map columns',
        'mapping_hint' => 'For each field pick the matching column in your file, or leave it blank to skip. Fields marked with * are required.',
        'skip_column' => '— Skip —',
        ...
        'stat_duplicates' => 'Duplicates (skipped)',
        'stat_errors' => 'Rows with errors',
        'errors_title' => 'Skipped rows',
        'error_row' => 'Row',
        'error_reason' => 'Reason',
